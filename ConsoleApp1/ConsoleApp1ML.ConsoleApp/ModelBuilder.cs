...
namespace ConsoleApp1ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\dev\CoffeeIntake\ai-playground\wikiDetoxAnnotated40kRows.txt";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options() { L2Regularization = 0.6557775f, L1Regularization = 0.4768731f, OptimizationTolerance = 1E-07f, HistorySize = 50, MaximumNumberOfIterations = 754049380, InitialWeightsDiameter = 0.99224f, DenseOptimizer = false, LabelColumnName = "Label", FeatureColumnName = "Features" });
